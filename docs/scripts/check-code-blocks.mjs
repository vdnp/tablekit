...
const tsconfig = {
  compilerOptions: {
    ...
    baseUrl: ".",
    paths: {
      "@vdnp/tablekit-core": ["../packages/core/src/index.ts"],
      "@vdnp/tablekit-react": ["../packages/react/src/index.ts"],
      "@vdnp/tablekit-theme": ["../packages/theme/src/index.ts"],
      "@vdnp/tablekit-react-native": ["../packages/react-native/src/index.ts"],
    },
  },
  include: ["*.tsx"],
};
