...
> **getRowModel**(): [`RowModel`](RowModel.md)\<`TData`\>

#### Returns

[`RowModel`](RowModel.md)\<`TData`\>
...
[`Updater`](../type-aliases/Updater.md)\<`Readonly`\<`Record`\<`string`, `boolean`\>\>\>
...
[`Updater`](../type-aliases/Updater.md)\<[`TableState`](TableState.md)\>
